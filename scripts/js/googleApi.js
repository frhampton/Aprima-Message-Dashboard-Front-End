/*Summary: This is the google api javascript file used for the google charts and tables
...
if (!window['google']['loader']) {
    ...
    google.loader.ClientLocation = {
        "latitude": 32.928,
        "longitude": -96.621,
        "address": {"city": "Garland", "region": "TX", "country": "USA", "country_code": "US"}
    };
    ...
    (function () {
        ...
        var m = "replace", n = "charAt", q = "getTime", r = "setTimeout", u = "push", v = "indexOf", w = "ServiceBase", x = "name", y = "length", z = "prototype", A = "loader", B = "substring", C = "join", D = "toLowerCase";
        ...
        l(google, function (a, b, c) {
            ...
            var f = a;
            c = c || {};
            if (a instanceof Array || a && "object" == typeof a && "function" == typeof a[C] && "function" == typeof a.reverse)for (var k = 0; k < a[y]; k++)e(a[k]); else e(a);
            if (a = N[":" + f]) {
        ...
        google[A].R = function (a) {
            if ((a = a.specs) && a[y])for (var b = 0; b < a[y]; ++b) {
                var c = a[b];
        ...
        U[z].v = function (a) {
            ...
            a && (b = a.packages);
            var c = null;
            if (b)if ("string" == typeof b)c = [a.packages]; else if (b[y])for (c = [], a = 0; a < b[y]; a++)"string" == typeof b[a] && c[u](b[a][m](/^\s*|\s*$/, "")[D]());
            c || (c = ["default"]);
            b = [];
        ...
        l(U[z], function (a, b) {
            var c = this.v(b), e = b && null != b.callback;
            if (e)var f = new W(b.callback);
            for (var k = [], p = c[y] - 1; 0 <= p; p--) {
                var t = c[p];
                e && f.I(t);
                if (this.i[":" + t])c.splice(p, 1), e && this.e[":" + t][u](f); else k[u](t)
            }
            if (c[y]) {
                b && b.packages && (b.packages = c.sort()[C](","));
                for (p = 0; p < k[y]; p++)t = k[p], this.e[":" + t] = [], e && this.e[":" + t][u](f);
                if (b || null == O[":" + this.b] || null == O[":" + this.b].versions[":" + a] || google[A].AdditionalParams || !this.l)b && b.autoloaded || google[A].d("script", this.g(a, b), e); else {
                    c = O[":" + this.b];
        ...
        V[z].O = function (a, b, c) {
            ...
            if (null != c)for (var f in c)a.params[f] ? e += "&" + X(a.params[f], c[f]) : "other_params" == f ? e += "&" + c[f] : "base_domain" == f && (b = "http://" + c[f] + a.uri[B](a.uri[v]("/", 7)));
            google[this[x]] = {};
            -1 == b[v]("?") && e && (e = "?" + e[B](1));
            return b + e
        };
        ...
        V[z].w = function (a) {
            if (this.o)for (var b = 0; b < this.o[y]; ++b) {
                var c = this.o[b];
        ...
        var ea = !1, Y = [], fa = (new Date)[q](), ha = function () {
    ...
    google.loader.rfm({
        ":search": {
            ...
            "js": "default+en.I.js",
            "css": "default+en.css",
            "properties": {":JSHash": "cb6ef4de1f03dde8c26c6d526f8a1f35", ":NoOldNames": false, ":Version": "1.0"}
        },
        ":language": {
            "versions": {":1": "1", ":1.0": "1"},
            "path": "/api/language/1.0/ab842e4cebe93c5ab08b2d3db3b8dc59/",
            "js": "default+en.I.js",
            "properties": {":JSHash": "ab842e4cebe93c5ab08b2d3db3b8dc59", ":Version": "1.0"}
        },
        ":feeds": {
            "versions": {":1": "1", ":1.0": "1"},
